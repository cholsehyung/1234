...
<h2 class="wow fadeInUp" data-wow-delay=".3s">Welcome to YOGIHOXY</h2>
<p class="wow fadeInUp" data-wow-delay=".5s">여러분들의 발품을 대신 해 드립니다.</p>
</div>
...
<option value="none">가구/인테리어</option>
<option value="none">디지털/가전</option>
<option value="none">식품</option>
<option value="none">남성의류/잡화</option>
<option value="none">여성의류/잡화</option>
<option value="none">뷰티/미용</option>
<option value="none">게임/취미</option>
